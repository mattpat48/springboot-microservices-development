...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay ref={ref} className={cn("fixed inset-0 z-50 bg-ink/35 backdrop-blur-sm", className)} {...props} />
));
...
>(({ className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-y-0 right-0 z-50 h-full w-full max-w-md border-l bg-background p-6 shadow-soft sm:max-w-lg",
        className
      )}
      {...props}
    >
